...
# テスト (CRuby Stage 0:38 + Stage 1:28 + Stage 2:26 + JIT-1:10 / AOT:47)
make test-cruby
make test-aot
make test-all
```
...
| JIT-2/3/4 | HIR 構築 + 最適化パス + LIR/codegen | 未着手 |
...
│   ├── test_stage_jit.rb     # CRuby JIT-1 テスト (10件)
