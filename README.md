...
## 現状: Stage 0 / 0.5 / 1 / 2 / 3a / 3b / 3c.1 / 3c.2 / 3c.3 / 3d.1 / 3d.2 / 3d.3 / 3d.4 / 3d.5 / 3e / GC-1 / GC-2 / JIT-1 / JIT-2 / JIT-3a / JIT-3b1 / JIT-3b2 / JIT-3b3 / JIT-3c / JIT-4 (案 A) 完了
...
- **継承 `class B < A`** (method/`@var`/`initialize` の継承、override、多段継承、動的ディスパッチ)
...
(テスト件数は `make test-cruby` 出力で確認できる。Stage 3a +38 件、3b +42 件、3c.1 +24 件、3c.2 +15 件、3c.3 +24 件、3d.1 +22 件、3d.2 +15 件、3d.3 +17 件、3d.4 +14 件、3d.5 +17 件、3e +21 件。)
